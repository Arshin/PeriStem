...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        */
        /*
        // delete anything in the core data
        let req : NSFetchRequest<NSFetchRequestResult> = NSFetchRequest(entityName: "Songs")
        ...
        */
        ...
        stemListforSongs.append(["name":"Odessey","Bass and Drums":"05 Space Oddity (Bass and Drums).m4p", "Strings":"06 Space Oddity (Strings).m4p"])
        stemListforSongs.append(["name":"Odessey2","Acoustic Guitar":"07 Space Oddity (Acoustic Guitar).m4p", "Lead Vocal":"11 Space Oddity (Lead Vocal).m4p"])
